...
import com.busata.bhammer.views.snackbar.layouts.SnackbarLayout;
...
import com.busata.bhammer.views.snackbar.listeners.DismissListener;
import com.busata.bhammer.views.snackbar.listeners.EventListener;
import com.busata.bhammer.views.snackbar.listeners.SwipeDismissTouchListener;
...
public class Snackbar extends SnackbarLayout {
    ...
    private int mMarginTop = BUtil.checkVersion(21) ? BUtil.dpToPx(24) : 0;
    ...
    private Snackbar(Context context, View fab) {
        super(context);
    ...
    public static Snackbar with(Context context, View fab) {
        return new Snackbar(context, fab);
    }

    /**
     * Sets the type of {@link com.busata.bhammer.views.snackbar.Snackbar} to be displayed.
     *
    ...
    /**
     * Sets the text to be displayed in this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param text
     * @return
     */
    ...
    /**
     * Sets the background color of this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param color
     * @return
     */
    ...
    /**
     * Sets the background drawable of this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param resId
     * @return
     */
    ...
    /**
     * Sets the text color of this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param textColor
     * @return
     */
    ...
    /**
     * Set the position of the {@link com.busata.bhammer.views.snackbar.Snackbar}. Note that if this is not set, the default is to
    ...
    /**
     * Sets all the margins of the {@link com.busata.bhammer.views.snackbar.Snackbar} to the same value, in pixels
     *
     * @param margin
     * @return
     */
    ...
    /**
     * Sets the margins of the {@link com.busata.bhammer.views.snackbar.Snackbar} in pixels such that the left and right are equal, and the top and bottom are equal
     *
     * @param marginLR
     * @param marginTB
     * @return
    ...
    /**
     * Sets all the margin of the {@link com.busata.bhammer.views.snackbar.Snackbar} individually, in pixels
     *
     * @param marginLeft
     * @param marginTop
     * @param marginRight
     ...
     * {@link com.busata.bhammer.views.snackbar.Snackbar#actionLabel(CharSequence)} for this button to be displayed
     *
     * @param actionColor
     * @return
     */
    ...
    /**
     * Determines whether this {@link com.busata.bhammer.views.snackbar.Snackbar} should dismiss when the action button is touched
     *
     * @param shouldDismiss
     * @return
     */
    ...
    /**
     * Sets the listener to be called when the {@link com.busata.bhammer.views.snackbar.Snackbar} action is
    ...
    /**
     * Sets the listener to be called when the {@link com.busata.bhammer.views.snackbar.Snackbar} is dismissed by swipe.
     *
     * @param listener
     * @return
     */
    ...
    /**
     * Determines whether this {@link com.busata.bhammer.views.snackbar.Snackbar} should allow the action button to be
    ...
    /**
     * Sets the listener to be called when the {@link com.busata.bhammer.views.snackbar.Snackbar} is dismissed.
     *
     * @param listener
     * @return
     */
    ...
    /**
     * Sets on/off both show and dismiss animations for this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param withAnimation
     * @return
     */
    ...
    /**
     * Sets on/off show animation for this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param withAnimation
     * @return
     */
    ...
    /**
     * Sets on/off dismiss animation for this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
     * @param withAnimation
     * @return
     */
    ...
    /**
     * Sets the duration of this {@link com.busata.bhammer.views.snackbar.Snackbar}. See
     * {@link com.busata.bhammer.views.snackbar.Snackbar.SnackbarDuration} for available options
     *
     * @param duration
     * @return
     */
    ...
    /**
     * Sets a custom duration of this {@link com.busata.bhammer.views.snackbar.Snackbar}
     *
    ...
    /**
     * Attaches this {@link com.busata.bhammer.views.snackbar.Snackbar} to an AbsListView (ListView, GridView, ExpandableListView) so
    ...
    /**
     * Attaches this {@link com.busata.bhammer.views.snackbar.Snackbar} to a RecyclerView so it dismisses when the list is scrolled
     *
    ...
    /**
     * Displays the {@link com.busata.bhammer.views.snackbar.Snackbar} at the bottom of the
    ...
    private void showInternal(Activity targetActivity, MarginLayoutParams params, ViewGroup parent) {
        ...
        slideIn.setDuration(BUtil.DEFAULT_ANIM_DURATION);
    ...
    private void dismiss(boolean animate) {
        ...
        slideOut.setDuration(BUtil.DEFAULT_ANIM_DURATION);
     ...
     * you know if (com.busata.bhammer.views.snackbar.Snackbar)}
     * was called. This is useful, for instance, if you want to know during
     * (com.busata.bhammer.views.snackbar.Snackbar)} if the
     * is being dismissed because of its action click
     */
    ...
    /**
     * @return the pixel offset of this from the left and
    ...
    /**
     * @return true if this  is currently showing
     */
    ...
    public void hideFab(boolean animate, boolean force) {
        toggle(false, animate, force);
    }

    private void toggle(final boolean visible, final boolean animate, boolean force) {
        if (mFabVisible != visible || force) {
            mFabVisible = visible;
            ...
            if (height == 0 && !force) {
                ...
                if (vto.isAlive()) {
                    vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                        @Override
                        public boolean onPreDraw() {
                            ViewTreeObserver currentVto = mFab.getViewTreeObserver();
            ...
            int translationY = visible ? -getHeight() : 0;
            if (animate) {
                Interpolator interpolator = visible ? new DecelerateInterpolator()
                        : new AccelerateInterpolator();

                ViewPropertyAnimator.animate(mFab).setInterpolator(interpolator)
                        .setDuration(BUtil.DEFAULT_ANIM_DURATION)
                        .translationY(translationY);
            } else {
                com.nineoldandroids.view.ViewHelper.setTranslationY(mFab, translationY);
            }
        }
    }
}

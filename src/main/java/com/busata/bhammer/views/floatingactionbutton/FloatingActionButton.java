package com.busata.bhammer.views.floatingactionbutton;
...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(R.color.accent_color));
        mColorPressed = mColorNormal;
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        ...
                        getIconDrawable(),
                        getResources().getDrawable(R.drawable.fab_selector)
                });

...
public class BDatePicker extends FrameLayout {
    ...
    private final BNumberPicker mDaySpinner;

    private final BNumberPicker mMonthSpinner;

    private final BNumberPicker mYearSpinner;
    ...
    public BDatePicker(Context context) {
        this(context, null);
    }
    ...
    public BDatePicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        // initialization based on locale
        setCurrentLocale(Locale.getDefault());

        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.BDatePicker,
                defStyle, 0);
        boolean spinnersShown = attributesArray.getBoolean(R.styleable.BDatePicker_dp_spinnersShown,
                DEFAULT_SPINNERS_SHOWN);
        boolean calendarViewShown = attributesArray.getBoolean(
                R.styleable.BDatePicker_dp_calendarViewShown, DEFAULT_CALENDAR_VIEW_SHOWN);
        int startYear = attributesArray.getInt(R.styleable.BDatePicker_dp_startYear,
                DEFAULT_START_YEAR);
        int endYear = attributesArray.getInt(R.styleable.BDatePicker_dp_endYear, DEFAULT_END_YEAR);
        String minDate = attributesArray.getString(R.styleable.BDatePicker_dp_minDate);
        String maxDate = attributesArray.getString(R.styleable.BDatePicker_dp_maxDate);
        int layoutResourceId = attributesArray.getResourceId(R.styleable.BDatePicker_dp_internalLayout,
        ...
        BNumberPicker.OnValueChangeListener onChangeListener = new BNumberPicker.OnValueChangeListener() {
            public void onValueChange(BNumberPicker picker, int oldVal, int newVal) {
                updateInputState();
        ...
        // day
        mDaySpinner = (BNumberPicker) findViewById(R.id.day);
        mDaySpinner.setFormatter(BNumberPicker.getTwoDigitFormatter());
        mDaySpinner.setOnLongPressUpdateInterval(100);
        mDaySpinner.setOnValueChangedListener(onChangeListener);
        mDaySpinnerInput = (EditText) mDaySpinner.findViewById(R.id.np__numberpicker_input);

        // month
        mMonthSpinner = (BNumberPicker) findViewById(R.id.month);
        ...
        // year
        mYearSpinner = (BNumberPicker) findViewById(R.id.year);
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(BDatePicker.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(BDatePicker.class.getName());
    }
     ...
     */
    private void setImeOptions(BNumberPicker spinner, int spinnerCount, int spinnerIndex) {

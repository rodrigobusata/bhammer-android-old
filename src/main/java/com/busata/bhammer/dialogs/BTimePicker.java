 ...
 */
//@Widget
public class BTimePicker extends FrameLayout {
    ...
    private static final OnTimeChangedListener NO_OP_CHANGE_LISTENER = new OnTimeChangedListener() {
        public void onTimeChanged(BTimePicker view, int hourOfDay, int minute) {
        }
    };
    ...
    // ui components
    private final BNumberPicker mHourSpinner;

    private final BNumberPicker mMinuteSpinner;

    private final BNumberPicker mAmPmSpinner;
    ...
    // version uses a BhammerNumberPicker spinner. Therefore the code
    ...
    public interface OnTimeChangedListener {
         ...
         */
        void onTimeChanged(BTimePicker view, int hourOfDay, int minute);
    }

    public BTimePicker(Context context) {
        this(context, null);
    }
    ...
    public BTimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // hour
        mHourSpinner = (BNumberPicker) findViewById(R.id.hour);
        mHourSpinner.setOnValueChangedListener(new BNumberPicker.OnValueChangeListener() {
            public void onValueChange(BNumberPicker spinner, int oldVal, int newVal) {
                updateInputState();
                if (!is24HourView()) {
        ...
        // minute
        mMinuteSpinner = (BNumberPicker) findViewById(R.id.minute);
        mMinuteSpinner.setMinValue(0);
        mMinuteSpinner.setMaxValue(59);
        mMinuteSpinner.setOnLongPressUpdateInterval(100);
        mMinuteSpinner.setFormatter(BNumberPicker.getTwoDigitFormatter());
        mMinuteSpinner.setOnValueChangedListener(new BNumberPicker.OnValueChangeListener() {
            public void onValueChange(BNumberPicker spinner, int oldVal, int newVal) {
                updateInputState();
        ...
        if (amPmView instanceof Button) {
            ...
            mAmPmButton = null;
            mAmPmSpinner = (BNumberPicker) amPmView;
            mAmPmSpinner.setMinValue(0);
            mAmPmSpinner.setMaxValue(1);
            mAmPmSpinner.setDisplayedValues(mAmPmStrings);
            mAmPmSpinner.setOnValueChangedListener(new BNumberPicker.OnValueChangeListener() {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(BTimePicker.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(BTimePicker.class.getName());
    }
    ...
    private void updateHourControl() {
        if (is24HourView()) {
            ...
            mHourSpinner.setFormatter(BNumberPicker.getTwoDigitFormatter());
        } else {
